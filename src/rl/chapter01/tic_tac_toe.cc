...
//                MATH21_ASSERT(0, "State Copy constructor.");
            ...
            void AIPlayer::beforePlay(math21::NumB isPrintState) {
                NumN first_or_second = sb == 1 ? 1 : 2;
                if (isPrintState) {
                    printf("AI player %ld is ready!\n", first_or_second);
                }
            }
            ...
            void HumanPlayer::beforePlay(math21::NumB isPrintState) {
                if (isPrintState) {
            ...
            void train(NumN epochs, NumN print_every_n = 500) {
                ...
                for (i = 1; i <= epochs; ++i) {
                    ...
                    if (i % print_every_n == 0) {
                        printf("Epoch %ld, player 1 win %.02f, win rate: %.02f, player 2 win %.02f, win rate: %.02f.\n",
            ...
            void compete(NumN turns) {
                ...
                printf("Compete results: %ld turns\n"

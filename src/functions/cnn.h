...
////#########################
    ...
    public:
        ...
        virtual void serialize(std::ostream &out, SerializeNumInterface &sn) {
            math21_serialize(out, d1, sn);
            math21_serialize(out, d2, sn);
        ...
        virtual void deserialize(std::istream &in, DeserializeNumInterface &sn) {
            ...
            math21_deserialize(in, d1, sn);
            math21_deserialize(in, d2, sn);
            ...
            for (NumN i = 1; i <= N; i++) {
                ...
                switch (type) {
                    ...
                    case cnn_type_fn_pooling:
                        ...
                        break;
                    default: MATH21_ASSERT(0, "UNKNOWN TYPE " << type);
                        break;
                }

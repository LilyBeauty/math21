...
namespace math21 {
        ...
        void GaussJordanElimination::solve(MatR &A, MatR &B) {
            ...
            for (i = 1; i <= n; i++) {
                ...
                index_r(i) = irow;
                index_c(i) = icol;
                if (A(icol, icol) == 0.0) MATH21_ASSERT(0, "Gauss-Jordan elimination: Singular Matrix");
        ...
        void GaussJordanElimination::solve(MatR &A) {
            MatR B;
            B.setSize(A.nrows(), 0);
            solve(A, B);
        }

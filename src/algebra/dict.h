...
namespace math21 {
    ...
    public:
        ...
        void serialize(std::ostream &io, SerializeNumInterface &sn) const {
            math21_io_serialize_container(io, a, sn);
            math21_io_serialize_container(io, b, sn);
            math21_io_serialize_container(io, idx, sn);
        }

        void deserialize(std::istream &io, DeserializeNumInterface &sn) {
            clear();
            math21_io_deserialize_container(io, a, sn);
            math21_io_deserialize_container(io, b, sn);
            math21_io_deserialize_container(io, idx, sn);
        }
